...
class SetStudentFinalScoreRequest extends AuthRequestBase {
  String studentId;
  String classId;
  int score;

  SetStudentFinalScoreRequest(this.studentId, this.classId, this.score);
  ...
  @override
  void setApiUrl(String url) => apiUrl = url + '/teacher/student/final';
}
